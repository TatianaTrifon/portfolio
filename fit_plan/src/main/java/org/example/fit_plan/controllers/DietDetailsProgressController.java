...
public class DietDetailsProgressController implements Initializable{
    ...
    public void showDetails(Diet diet) {
            ...
            contentPane.getChildren().addAll(dietImageView, titleLabel, deleteButton,detailsBox);
        }
        ...
        public void deleteFromProgress(){
            ...
            boolean isDeleted = userAccountDAO.deleteDietById(userId);

            if(isDeleted){
                alert.setContentText("Diet was deleted from favorites!");
                alert.showAndWait();
            } else {
                alert.setAlertType(Alert.AlertType.ERROR);
                alert.setContentText("Failed to delete the diet from your favorites");
                alert.showAndWait();
            }
